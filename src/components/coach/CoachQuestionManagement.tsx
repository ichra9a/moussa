...
const CoachQuestionManagement = () => {
  ...
  const fetchQuestions = async () => {
    try {
      ...
      toast({
        title: "خطأ",
        description: "حدث خطأ أثناء جلب الأسئلة",
        variant: "destructive"
      });
    } finally {
      setLoading(false);
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Dialog>
                      ...
                      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto font-cairo" dir="rtl">
                        <DialogHeader>
...
export default CoachQuestionManagement;
