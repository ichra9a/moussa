    ...
    <section className="bg-white py-12 font-cairo">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-6">
          <h2 className="text-3xl font-bold text-slate-900 arabic-heading">ابحث عن الدرس المناسب</h2>
          ...
          <div className="max-w-2xl mx-auto relative">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pr-12 pl-4 py-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-lg arabic-text text-right"
                dir="rtl"
              />
            </div>
          </div>
